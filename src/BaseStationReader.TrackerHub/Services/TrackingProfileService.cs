...
public sealed class TrackingProfileService : ITrackingProfileService
{
    ...
    internal static TrackerApplicationSettings Clone(TrackerApplicationSettings source) => new()
    {
        ...
        LogFile = source.LogFile, VerboseLogging = source.VerboseLogging,
        TrackingLogSummaryInterval = source.TrackingLogSummaryInterval, EnableSqlWriter = source.EnableSqlWriter,
