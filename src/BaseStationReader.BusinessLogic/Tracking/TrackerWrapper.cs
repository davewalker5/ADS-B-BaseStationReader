    ...
    public class TrackerWrapper : ITrackerWrapper
    {
        ...
        public async Task InitialiseAsync()
        {
            ...
            if (_settings.EnableSqlWriter)
            {
                ...
                var apiWrapper = ExternalApiFactory.GetWrapperInstance(_logger, TrackerHttpClient.Instance, context, aircraftWriter, serviceType, ApiEndpointType.ActiveFlights, _settings, null);
