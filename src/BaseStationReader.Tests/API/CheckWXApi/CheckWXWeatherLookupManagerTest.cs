...
{
    [TestClass]
    public class CheckWXWeatherLookupManagerTest
    {
        ...
        public void Initialise()
        {
            ...
            var api = new ExternalApiFactory().GetApiInstance(ApiServiceType.CheckWXApi, ApiEndpointType.METAR, _client, factory, _settings);
            var register = new ExternalApiRegister(logger);
            register.RegisterExternalApi(ApiEndpointType.METAR, api);
