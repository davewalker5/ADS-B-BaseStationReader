...
public class PositionDensitySnapshotMergerTest
{
    ...
    public void MergeRetainsMissingBinsAndOnlyIncreasesCountsTest()
    {
        var current = Density(28, 12,
            new PositionDensityBin { Latitude = 51.5, Longitude = -0.2, Count = 4 },
            new PositionDensityBin { Latitude = 51.6, Longitude = -0.1, Count = 2 });
        var refreshed = Density(28, 11,
            new PositionDensityBin { Latitude = 51.5, Longitude = -0.2, Count = 3 },
            new PositionDensityBin { Latitude = 51.7, Longitude = 0.0, Count = 5 });
    ...
    public void MergeReplacesSnapshotWhenSessionChangesTest()
    {
        ...
        var refreshed = Density(29, 1,
            new PositionDensityBin { Latitude = 50.0, Longitude = 1.0, Count = 1 });
    ...
    private static PositionDensity Density(
        int sessionId,
        int positionCount,
        params PositionDensityBin[] bins)
        => new()
        {
            SessionId = sessionId,
