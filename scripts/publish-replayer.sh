...
PROJECT_FILE="$PROJECT_FOLDER/BaseStationReader.SpoolReplayer/BaseStationReader.SpoolReplayer.csproj"
CONFIG_FILE="$PROJECT_FOLDER/config/replayer/appsettings.$1.json"
PUBLISH_FOLDER="$PROJECT_FOLDER/published/replayer/$1"
MY_APPS_BASE_FOLDER=$(~/Scripts/get-my-apps-folder.sh)
MY_APPS_FOLDER=$MY_APPS_BASE_FOLDER/BaseStationReader/replayer
