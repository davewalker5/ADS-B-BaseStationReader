...
PROJECT_FILE="$PROJECT_FOLDER/BaseStationReader.Lookup/BaseStationReader.Lookup.csproj"
CONFIG_FILE="$PROJECT_FOLDER/config/lookup/appsettings.$1.json"
PUBLISH_FOLDER="$PROJECT_FOLDER/published/lookup/$1"
MY_APPS_BASE_FOLDER=$(~/Scripts/get-my-apps-folder.sh)
MY_APPS_FOLDER=$MY_APPS_BASE_FOLDER/BaseStationReader/lookup
