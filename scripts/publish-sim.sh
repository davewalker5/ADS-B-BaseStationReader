...
PROJECT_FILE="$PROJECT_FOLDER/BaseStationReader.Simulator/BaseStationReader.Simulator.csproj"
CONFIG_FILE="$PROJECT_FOLDER/config/simulator/appsettings.$1.json"
PUBLISH_FOLDER="$PROJECT_FOLDER/published/simulator/$1"
MY_APPS_BASE_FOLDER=$(~/Scripts/get-my-apps-folder.sh)
MY_APPS_FOLDER=$MY_APPS_BASE_FOLDER/BaseStationReader/simulator
